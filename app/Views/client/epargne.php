...
<div class="stats-grid">
  <div class="stat-card">
    ...
    <div class="stat-info">
      ...
      <div class="stat-sub">Appliqué à chaque transfert</div>
    </div>
  </div>
  <div class="stat-card">
    ...
    <div class="stat-info">
      ...
      <div class="stat-sub">Cumul de vos transferts</div>
    </div>
  </div>
</div>
...
<div class="card" style="margin-bottom: 20px;">
  ...
  <div class="card-body">
    <p style="color: var(--text-secondary); margin-bottom: 16px;">
      Un pourcentage de vos transferts sera automatiquement mis de côté.
    </p>
...
<div class="card">
  ...
  <div class="card-body">
    <ul style="color: var(--text-secondary); line-height: 2; padding-left: 20px;">
      ...
      <li>Lors de chaque transfert, ce pourcentage est prélevé et mis de côté</li>
      <li>L'épargne est déduite du montant total avant l'envoi</li>
